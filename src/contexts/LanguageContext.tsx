...
const translations: Record<string, Record<Language, string>> = {
  ...
  author_title: {
    ...
    ar: 'جامع المشاعر وتأمّلات الروح وحكايات الوطن'
  },
  about_author: {
    en: 'About the Author',
    ar: 'عن المؤلّف'
...
وقد قسّم الديوان إلى أربعة أبواب تمثل مواضيع رئيسية تنوعت بين ألوان الحياة المختلفة، من غزل ينبض بالشوق والشّغف والجمال، ووطنيات تعكس روح الانتماء والفخر بالوطن، وحِكم مُستمدَّة من تجارب حياتيّة عاشها الشاعر فقولبها في قصائده، ووجدانيات تلخّص أعمق المشاعر في لحظات التّامل.

قرأ فيه أحد الشعراء ديوانًا ينبض بالوجدان طيّ واحةٍ من العشق للمرأة وللوطن، أشواكها حشرجات تتبختر في بيادر الفكر بين عتب وسكوت، بين حرقةٍ وحنين، ودمع مالح ينضح من دواة حبر الشاعر المُتدفّق من أرز لبنان.
